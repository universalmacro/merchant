...
require (
	...
	github.com/universalmacro/merchant-api-interfaces v0.0.0-20240314063719-bf188baab9e3
...
require (
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/sms v1.0.865 // indirect
